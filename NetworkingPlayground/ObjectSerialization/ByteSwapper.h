...
namespace Serialization {
	...
	inline uint16_t ByteSwap2(uint16_t inData) noexcept
	{
		return (inData >> 8) | (inData << 8);
	}

	inline uint32_t ByteSwap4(uint32_t inData) noexcept
	{
	...
	inline uint64_t ByteSwap8(uint64_t inData) noexcept
	{
